...
export function createHostWhispererRuntime(config: HostWhispererConfig) {
  ...
  const styles = `<style>
    :host{all:initial;font-family:Inter,ui-sans-serif,system-ui;color:#182019}button,input{font:inherit}.hw-launch{position:fixed;right:22px;bottom:22px;z-index:2147483000;border:0;border-radius:999px;background:#172019;color:white;padding:14px 18px;box-shadow:0 14px 40px #1019104d;font-weight:800;cursor:pointer;animation:hw-arrive .45s ease-out}.hw-launch i{display:inline-block;width:8px;height:8px;border-radius:50%;background:#79d69d;margin-right:9px;box-shadow:0 0 0 0 #79d69d;animation:hw-pulse 2s infinite}.hw-panel{position:fixed;right:22px;bottom:82px;width:390px;max-height:76vh;overflow:auto;z-index:2147483000;background:#fbfaf6;border:1px solid #d8d5cb;border-radius:18px;box-shadow:0 24px 70px #10191033;padding:20px;animation:hw-arrive .25s ease-out}.hw-head{display:flex;justify-content:space-between;gap:12px}.hw-brand{font-size:11px;text-transform:uppercase;letter-spacing:.1em;color:#176b4c;font-weight:900}.hw-head h2{font:700 24px Georgia,serif;margin:5px 0}.hw-close{border:0;background:transparent;font-size:22px;cursor:pointer}.hw-copy{color:#687068;font-size:13px;line-height:1.5}.hw-input{box-sizing:border-box;width:100%;border:1px solid #cbc8bf;border-radius:10px;padding:11px;margin:10px 0;background:white}.hw-primary,.hw-approve{width:100%;border:0;border-radius:10px;padding:11px;background:#172019;color:white;font-weight:800;cursor:pointer}.hw-status{margin:14px 0;padding:11px;border-radius:10px;background:#edf5ed;font-size:12px}.hw-card{border:1px solid #ddd9cf;border-radius:12px;padding:13px;margin:12px 0;animation:hw-arrive .28s ease-out}.hw-card h3{margin:0 0 6px;font-size:14px}.hw-card p,.hw-card li{font-size:12px;line-height:1.45;color:#5c645d}.hw-card ul{padding-left:18px}.hw-approve{background:#176b4c}.hw-activity{border-top:1px solid #ddd9cf;margin-top:16px;padding-top:12px}.hw-activity h3{font-size:11px;text-transform:uppercase;letter-spacing:.08em}.hw-event{display:grid;grid-template-columns:10px 1fr;gap:9px;margin:10px 0;animation:hw-event-in .36s ease-out}.hw-event i{width:8px;height:8px;border-radius:50%;background:#2b9369;margin-top:4px}.hw-event.running i{background:#d49621;animation:hw-pulse 1s infinite}.hw-event.failed i{background:#cb5548}.hw-event.approval i{background:#5f6fd6}.hw-event strong{display:block;font-size:11px}.hw-event span{font-size:10px;color:#70766f}.hw-ready{color:#176b4c;font-weight:800}.hw-agent-request{background:#172019;color:white;border-radius:12px;padding:14px;margin:12px 0}.hw-agent-request span{display:block;color:#a9b4aa;font-size:10px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:5px}.hw-agent-request strong{font-size:16px}.hw-agent-request p{color:#cbd2cb;font-size:11px;line-height:1.45;margin:7px 0 0}@keyframes hw-arrive{from{opacity:0;transform:translateY(12px) scale(.98)}to{opacity:1;transform:none}}@keyframes hw-event-in{from{opacity:0;transform:translateX(10px)}to{opacity:1;transform:none}}@keyframes hw-pulse{70%{box-shadow:0 0 0 7px transparent}}
  </style>`;
